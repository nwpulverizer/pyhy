...
This repository was written on Python version 3.7.6 and requires Python 3.
This has been updated to use the pixi environment manager. To install run pixi install after you clone the repo.
From there you can run pixi shell and you will be in the pyhy environment.
